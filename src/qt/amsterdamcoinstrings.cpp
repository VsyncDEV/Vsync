...
QT_TRANSLATE_NOOP("amsterdamcoin-core", "Copyright (C) 2015-%i The Vsync Core Developers"),
...
QT_TRANSLATE_NOOP("amsterdamcoin-core", "Error loading wallet.dat: Wallet requires newer version of Vsync Core"),
...
QT_TRANSLATE_NOOP("amsterdamcoin-core", "Initialization sanity check failed. Vsync Core is shutting down."),
...
QT_TRANSLATE_NOOP("amsterdamcoin-core", "Wallet needed to be rewritten: restart Vsync Core to complete"),
