...
*Setup instructions for a gitian build of Vsync using a Debian VM or physical system.*
...
- [Building Vsync](#building-amsterdamcoin)
...
To build Vsync (for Linux, OSX and Windows) just follow the steps under 'perform
